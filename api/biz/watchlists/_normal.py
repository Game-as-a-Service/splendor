...
class NormalHandler(WatchlistHandler):
    ...
    @inject_service()
    def __init__(self, user_sql_session: Session, normal_account_service: NormalAccountService):
        super().__init__()
        self._user_sql_session = user_sql_session
        self._normal_account_service = normal_account_service

    def _get_normal_account_by_user_id(self, user_id: str) -> NikeCustomerInfo:
    ...
    def add_watchlist(self, user_id: str, name: str) -> str:
        user: NikeCustomerInfo = self._get_normal_account_by_user_id(user_id)
        if not user:
    ...
    def delete_watchlist(self, user_id: str, watchlist_id: str) -> None:
        ...
        self._update_watchlist(user_id, watchlist)
        self._normal_account_service.modify_watchlist_index_by_user_id(user_id, 0)
