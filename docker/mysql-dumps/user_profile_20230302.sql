...
CREATE TABLE `cancel_subscribe_record` (
...
CREATE TABLE `institution_exclusive_offers` (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '流水碼',
...
CREATE TABLE `nike_customer_info` (
...
DROP TABLE IF EXISTS `stripe_session_info`;
CREATE TABLE `stripe_session_info` (
  `session_id` varchar(100) COLLATE utf8_unicode_ci NOT NULL COMMENT '訂單 session 編號',
  `payment_status` varchar(10) COLLATE utf8_unicode_ci NOT NULL COMMENT '付款狀態, unpaid: 待處理, paid: 付款成功',
  `user_id` varchar(100) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Growin 客戶編號',
  `customer_id` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Stripe 客戶編號',
  `subscription_id` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Stripe 訂閱編號',
  `updated_at` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '資料異動時間，當update資料時自動更新 CURRENT_TIMESTAMP',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '資料建立時間，當資料建立時自動設為 CURRENT_TIMESTAMP',
  PRIMARY KEY (`session_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8_unicode_ci;

DROP TABLE IF EXISTS `stripe_subscribe_info`;
CREATE TABLE `stripe_subscribe_info` (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '流水碼',
  `subscription_id` varchar(100) COLLATE utf8_unicode_ci NOT NULL COMMENT '訂閱編號',
  `customer_id` varchar(100) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Stripe 客戶編號',
  `price_id` varchar(100) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Stripe 方案編號',
  `plan` varchar(50) COLLATE utf8_unicode_ci NOT NULL COMMENT '方案名稱',
  `currency` varchar(3) COLLATE utf8_unicode_ci NOT NULL COMMENT '幣別',
  `discount` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '折價券',
  `exp_month` int DEFAULT NULL COMMENT '信用卡有效月份',
  `exp_year` int DEFAULT NULL COMMENT '信用卡有效年份',
  `last_four` varchar(4) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '信用卡末四碼',
  `total` decimal(12,2) NOT NULL COMMENT '總支付金額',
  `receipt_pdf_link` varchar(1000) COLLATE utf8_unicode_ci NOT NULL COMMENT '收據連結',
  `invoice_number` varchar(20) COLLATE utf8_unicode_ci NOT NULL COMMENT '帳單編號',
  `receipt_number` varchar(20) COLLATE utf8_unicode_ci NOT NULL COMMENT '收據編號',
  `subscribed_at` date NOT NULL COMMENT '訂閱日期',
