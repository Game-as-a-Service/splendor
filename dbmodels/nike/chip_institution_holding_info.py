...
class ChipInstitutionHoldingInfo(Base):
    __tablename__ = "chip_institution_holding_info"
    __table_args__ = {
        "mysql_partition_by": """
    ...
    inst_ownshp = Column(DECIMAL(40, 12), nullable=True, comment="機構持有率")
    inst_count = Column(INTEGER, nullable=True, comment="持有機構數")
    conti_add = Column(INTEGER, nullable=True, comment="連續加碼季數")
