...
class SymbolHistoricalDividendInfo(Base):
    __tablename__ = "symbol_historical_dividend_info"
    __table_args__ = {
        "mysql_partiton_by": """
    ...
    __table_args__ = (
        ...
        Index("index_year_column", "year", unique=False),
    )
    ...
    cash_dividend = Column(DECIMAL(40, 12), nullable=False, comment="現金股利")
    stock_dividend = Column(DECIMAL(40, 12), nullable=False, comment="股票股利")
    total_dividend = Column(DECIMAL(40, 12), nullable=False, comment="股利合計")
    filled_days = Column(INTEGER, nullable=True, comment="填息花費日")
    dividend_yield = Column(DECIMAL(40, 12), nullable=False, comment="殖利率")
    eps = Column(DECIMAL(40, 12), nullable=True, comment="EPS")
    payout_ratio = Column(DECIMAL(40, 12), nullable=True, comment="盈餘分配率")
